...
import MernStack from '../assets/All Image/mernstack.png';
import Html from '../assets/All Image/Html.png';
import Css from '../assets/All Image/CSS.png';
import Javascript from '../assets/All Image/JS.png';
...
import Bootstrap from '../assets/All Image/Bootstrap.png';
import NodeLogo from '../assets/All Image/NodeLogo.png';
import Mongodb from '../assets/All Image/mongodb.svg';
import Express from '../assets/All Image/Express.png';
import NextJs from '../assets/All Image/NextJs.png';
import Firebase from '../assets/All Image/Firebase.png';
import Vercel from '../assets/All Image/Vercel.png';
import Netlify from '../assets/All Image/netlify.png';
import git from '../assets/All Image/git.png';
import githube from '../assets/All Image/git.png';
import Vscode from '../assets/All Image/Vscode.png';
import Figma from '../assets/All Image/Figma-Logo-v2.png';
import postman from '../assets/All Image/postman.png';
          ...
          <div className="mt-10">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
              ...
              <div className="border border-red-200 rounded-lg md:p-7 py-7  flex flex-col gap-8 items-center shadow-lg shadow-red-300">
                ...
                <div>
                  <h3 className="text-2xl pb-4 text-center font-semibold">
                    Frontend & Backend
                  </h3>
                  <div className="flex items-center justify-center flex-wrap gap-3">
                    ...
                    <div className="border border-red-300 flex items-center gap-1 w-max px-2 py-1 rounded-lg shadow-md shadow-red-300">
                      <img src={Vercel} alt="" className="w-9" />
                ...
                <div>
                  ...
                  <div className="flex items-center justify-center flex-wrap gap-3">
                    ...
                    <div className="border border-red-300 flex items-center gap-1 w-max px-2 py-1 rounded-lg shadow-md shadow-red-300">
                      <img src={githube} alt="" className="w-9 h-9" />
                    ...
                    <div className="border border-red-300 flex items-center gap-1 w-max px-2 py-1 rounded-lg shadow-md shadow-red-300">
                      <img src={Figma} alt="" className="w-9 rounded-full" />
